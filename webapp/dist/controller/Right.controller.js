  ...
  function (
    ...
    return e.extend("com.sz.packoutbdlv.controller.Right", {
      ...
      updateParameterAfterCreation: function (e, i) {
        ...
        var n = sap.ui.core.Fragment.createId(this.getTabId(a), "hu-lwh-unit0");
        var o = sap.ui.core.Fragment.createId(this.getTabId(a), "hu-lwh-unit1");
        var l = sap.ui.core.Fragment.createId(this.getTabId(a), "hu-lwh-unit2");
        var u = this.byId(n);
        var h = this.byId(o);
        var g = this.byId(l);
        u.setText(e.UnitLwh);
