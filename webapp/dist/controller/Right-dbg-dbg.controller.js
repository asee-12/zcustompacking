sap.ui.define([
	...
	return Controller.extend("com.sz.packoutbdlv.controller.Right", {
		...
		updateParameterAfterCreation: function (preResult, mSession) {
			...
			var huLWHUnit0 = sap.ui.core.Fragment.createId(this.getTabId(sShipHUId), "hu-lwh-unit0");
			var huLWHUnit1 = sap.ui.core.Fragment.createId(this.getTabId(sShipHUId), "hu-lwh-unit1");
			var huLWHUnit2 = sap.ui.core.Fragment.createId(this.getTabId(sShipHUId), "hu-lwh-unit2");			
